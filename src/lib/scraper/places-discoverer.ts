...
export const PLACES_CITIES: Record<string, Array<{ city: string; province: string }>> = {
  NS: [
    ...
    { city: 'Cheticamp', province: 'NS' },
    { city: 'Canso', province: 'NS' },
    { city: 'Guysborough', province: 'NS' },
    { city: 'Tatamagouche', province: 'NS' },
    { city: 'Pugwash', province: 'NS' },
    ...
    { city: 'Barrington', province: 'NS' },
    { city: 'Clark\'s Harbour', province: 'NS' },
    { city: 'Meteghan', province: 'NS' },
    { city: 'Church Point', province: 'NS' },
    { city: 'Enfield', province: 'NS' },
    { city: 'Elmsdale', province: 'NS' },
    { city: 'Tantallon', province: 'NS' },
    { city: 'Musquodoboit Harbour', province: 'NS' },
    { city: 'Sheet Harbour', province: 'NS' },
    { city: 'North Sydney', province: 'NS' },
    { city: 'Louisbourg', province: 'NS' },
    { city: 'Dominion', province: 'NS' },
    { city: 'Arichat', province: 'NS' },
    { city: 'Sherbrooke', province: 'NS' },
  ],
  NB: [
    // Major cities
    ...
    { city: 'Quispamsis', province: 'NB' },
    { city: 'Grand Bay-Westfield', province: 'NB' },
    { city: 'St. Andrews', province: 'NB' },
    { city: 'St. Stephen', province: 'NB' },
    { city: 'St. George', province: 'NB' },
    { city: 'Blacks Harbour', province: 'NB' },
    ...
    { city: 'McAdam', province: 'NB' },
    { city: 'Chipman', province: 'NB' },
    { city: 'Doaktown', province: 'NB' },
    { city: 'Blackville', province: 'NB' },
    { city: 'Rogersville', province: 'NB' },
    { city: 'Rexton', province: 'NB' },
    { city: 'Alma', province: 'NB' },
    { city: 'Petitcodiac', province: 'NB' },
    { city: 'Salisbury', province: 'NB' },
    { city: 'Harvey', province: 'NB' },
    { city: 'Gagetown', province: 'NB' },
    { city: 'Grand Manan', province: 'NB' },
    { city: 'Deer Island', province: 'NB' },
  ],
  PEI: [
    // Major cities
    ...
    { city: 'Georgetown', province: 'PEI' },
    { city: 'Kensington', province: 'PEI' },
    { city: 'Alberton', province: 'PEI' },
    { city: 'Tignish', province: 'PEI' },
    { city: "O'Leary", province: 'PEI' },
    { city: 'Murray Harbour', province: 'PEI' },
    { city: 'Murray River', province: 'PEI' },
    { city: 'Cavendish', province: 'PEI' },
    { city: 'North Rustico', province: 'PEI' },
    { city: 'Hunter River', province: 'PEI' },
    { city: 'Brackley Beach', province: 'PEI' },
    { city: 'Borden-Carleton', province: 'PEI' },
    { city: 'Crapaud', province: 'PEI' },
