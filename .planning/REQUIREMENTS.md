...
- [x] **SER-05**: Gemini extraction includes optional recurrence_pattern hint from page content
- [x] **SER-06**: Existing events backfilled with series detection on first run
