...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 03-01-01 | 01 | 1 | MAP-04 | unit | `npm test -- --testPathPattern=filter-utils` | ❌ W0 | ⬜ pending |
| 03-01-02 | 01 | 1 | MAP-05 | unit | `npm test -- --testPathPattern=filter-utils` | ❌ W0 | ⬜ pending |
| 03-01-03 | 01 | 1 | MAP-06 | unit | `npm test -- --testPathPattern=filter-utils` | ❌ W0 | ⬜ pending |
| 03-02-01 | 02 | 1 | MAP-08 | unit | `npm test -- --testPathPattern=events-api` | ❌ W0 | ⬜ pending |
| 03-03-01 | 03 | 2 | MAP-01 | manual-only | Visual check in browser | N/A | ⬜ pending |
| 03-03-02 | 03 | 2 | MAP-02 | manual-only | Visual check in browser | N/A | ⬜ pending |
| 03-03-03 | 03 | 2 | MAP-03 | manual-only | Visual check in browser | N/A | ⬜ pending |
| 03-03-04 | 03 | 2 | MAP-07 | manual-only | Requires browser API | N/A | ⬜ pending |
| 03-03-05 | 03 | 2 | MAP-09 | manual-only | Visual check at 375px | N/A | ⬜ pending |
| 03-03-06 | 03 | 2 | INFR-02 | manual-only | DevTools Network check | N/A | ⬜ pending |
...
- [ ] `src/lib/filter-utils.test.ts` — stubs for MAP-04, MAP-05, MAP-06 filter functions
- [ ] `src/app/api/events/route.test.ts` — stubs for MAP-08 API shape; mocks Drizzle db client
